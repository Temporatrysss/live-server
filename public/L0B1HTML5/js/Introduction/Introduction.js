...
function Introduction(obj, inside) {
  ...
  img.onload = function() {
    ...
    for (var i = 1; i < objList.length; i++) {
      ...
      objList[i].Left =
        objList[i].Left + objList[0].Left + objList[0].ShiftPointX;
      ...
      switch (objList[i].FormatterType) {
        ...
        case 'AdditionalFile':
          ...
          AdditionalCanvasSet(objList[i], MainObj.NowPage);
          break;
